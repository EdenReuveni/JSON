...
class Monom_JUNIT {
	...
	@Test
	void testAdd() {
		this.monomAc.add(monomEx);
		assertTrue("Checks the coefficients: ", (monomAc.get_coefficient()+monomEx.get_coefficient())==monomAc.get_coefficient());
		assertTrue("Checks the powers: ", monomAc.get_power()==2);
